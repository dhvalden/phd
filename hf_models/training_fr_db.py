...
df = pd.read_csv('./data/fr_data.csv',
...
for epoch in tqdm(range(1, epochs+1)):
    ...
    torch.save(model.state_dict(), f'trained_models/fr_distilBERT_epoch_{epoch}.model')
    tqdm.write(f'\nEpoch {epoch}')
...
model.load_state_dict(torch.load('trained_models/fr_distilBERT_epoch_4.model',
