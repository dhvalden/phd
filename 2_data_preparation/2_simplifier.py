...
"""
This script receive the digested_* files outputed by ingester
and outputs files with the prefix simple_* with less fields.
Simple_ files are joined together and then separeted by social movement
topic using filterbytopic.py
"""
